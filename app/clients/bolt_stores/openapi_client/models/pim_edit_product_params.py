...
class PimEditProductParams(BaseModel):
    """
    Information regarding updating products
    """ # noqa: E501
    ...
    barcodes: Optional[List[Annotated[str, Field(min_length=1, strict=True, max_length=255)]]] = Field(default=None, description="An array of product's barcodes. Barcodes must be unique across all products ")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PimEditProductParams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PimEditProductParams from a dict"""
        if obj is None:
            return None
